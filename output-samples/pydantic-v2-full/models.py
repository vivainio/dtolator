# Generated by dtolator --from-openapi full-sample.json --pydantic --pydantic-version 2
...
class PaymentMethod(BaseModel):
    ...
    last4: str | None = Field(None, pattern=r"^[0-9]{4}$", description="Last 4 digits of card (for card payments)")
...
class CreateUserRequest(BaseModel):
    ...
    email: EmailStr
    password: str = Field(min_length=8, max_length=128, pattern=r"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]")
    profile: UserProfile
