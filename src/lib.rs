    ...
    match options.generator_type {
        ...
        GeneratorType::Pydantic => {
            ...
            let init_content = format!(
                "# Generated by {command_string}\n# Do not modify manually\n\nfrom .models import *\n"
            );
            let init_path = options.output_dir.join("__init__.py");
            write_if_changed(&init_path, &init_content)?;
            written_files.push("__init__.py".to_string());
        }
        GeneratorType::PythonDict => {
